"""Overtake, defense and maneuver-group racecraft extracted from RaceEngine.
...
from simulation.vehicle_physics import PHYSICS_MAX_LATERAL_SPEED_MPS, PHYSICS_STEP_SECONDS
